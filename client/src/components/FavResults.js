          ...
          <div className="col-md-8" style={{ lineHeight: '0.75em', fontSize: '1em' }}>
            <div className="card-body">
              ...
              <div>
                ...
                <button className="btn btn-outline-danger m-1" onClick={props.handleDelete}>Delete</button>
                <a href={props.url} target="_blank" rel="noopener noreferrer" className="ml-1 mt-3 text-dark" style={{ display: 'inline-block', width: '100%' }}>More Info</a>
              </div>
            </div>
          </div>
        </div>
